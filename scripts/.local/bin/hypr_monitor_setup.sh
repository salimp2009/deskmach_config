...
# Make it executable:
# chmod +x ~/.config/hypr/monitor_setup.sh

# Then just add this to the hyprland.config:
# exec-once = ~/.config/hypr/monitor_setup.sh
# for testing without restarting hypr, just just run this from terminal: ~/.config/hypr/monitor_setup.sh#
